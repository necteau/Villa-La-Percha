...
| 4 | PlatformLead Triage Tools | In progress | — | `bcf22be`, `e10b8bc`, `55243f3`, `3b49965` / production `directstay.app` | Status and notes slices shipped: admin can open a stable PlatformLead detail route, update status, add internal notes, see notes in the lead timeline, and audit both mutations. Preview and production QA passed for status and notes; production authenticated QA passed 6/6. Remaining: assignment, follow-up date, source tracking, richer timeline polish. |
