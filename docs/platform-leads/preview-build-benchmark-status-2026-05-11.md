...
| Sarasota River Retreat | Gulf Coast riverfront retreat | Image-source review, constrained content plan, DESIGN fingerprint, rubric preflight, and fixture-ready render packet complete; no render | Owner prose shows a distinct river/canal archetype. 2026-05-12 HTML/image inspection found one confirmed property-specific living-room image; river/pool/dock/kayak exterior art was not confirmed, and most other assets are local/stock/attraction images. 2026-05-13 content plan and 2026-05-14 design/rubric preflight define the safe path; `sarasota-river-retreat-render-fixture-packet-2026-05-14.md` now provides a local-fixture payload with text-forward hero, living-room trust image, text-only amenity modules, read-only inquiry/trip-total structure, owner-correction checklist, and guest-view denylist. | Full owner/gallery photo set, photo rights, safe exterior/amenity hero, water/pool/spa/kayak rules, rates/policies, owner recommendations. |
...
The next DirectStay Preview Build refinement heartbeat can render a constrained **internal-only Sarasota benchmark** from `sarasota-river-retreat-render-fixture-packet-2026-05-14.md` using a local fixture/test-seed path. Do not create production database rows, share an owner-facing Sarasota preview, or use exterior/amenity imagery until an owner/gallery photo set supports safe hero and early-section art.
