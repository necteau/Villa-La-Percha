...
const fixture = {
  ...
  preview: {
    ...
    location: "Sarasota, Florida / Phillippi River",
    sourceUrls: [],
    heroTitle: "A quiet Sarasota river retreat, planned around the questions guests ask before they book.",
    positioning: "A careful sample page for a small waterfront home where the value is morning river rhythm, private pool and spa questions, dock and kayak planning, and direct owner care.",
    sections: [
      {
        kind: "heroTextOnly",
        eyebrow: "Sarasota river stay",
        title: "A quiet Sarasota river retreat, planned around the questions guests ask before they book.",
        body: "A careful sample page for a small waterfront home where the value is morning river rhythm, private pool and spa questions, dock and kayak planning, and direct owner care.",
        badges: ["Sarasota / Phillippi River context", "3 bedrooms", "Sleeps 6", "Rules and pricing confirmed before launch"],
        imageUrl: null
      },
      {
        kind: "stayFit",
        eyebrow: "Stay fit",
        title: "Quick planning checks before anyone asks for dates.",
        items: [
          { label: "3 bedrooms / sleeps 6", body: "Final bed and bathroom layout should be confirmed before guests rely on it." },
          { label: "Sarasota waterfront / Phillippi River setting", body: "A guest-ready page should clarify access, arrival, parking, and water-use details in plain language." },
          { label: "Pool, spa, dock, kayaks, and firepit", body: "Guest rules, heating, safety, and seasonal availability should be easy to check before inquiry." },
      ...
      },
      {
        ...
        title: "Start with the cared-for interior.",
      ...
      },
      {
        ...
        title: "Plan the river day before promising it.",
        body: "A useful direct-booking page should help guests understand the pool, spa, dock, kayaks, weather, and quiet-hour expectations before they send an inquiry.",
        items: [
          "Morning river atmosphere, without guaranteeing wildlife sightings.",
          "Pool and spa reset, with heating, hours, fees, and safety rules made clear.",
          "Dock and kayak questions, including launch rules, life jackets, weather guidance, and water-use approvals.",
          "Firepit evening, with permitted use, fuel, quiet hours, and safety rules clarified."
        ]
      },
      {
        kind: "calendarMock",
        ...
        body: "Guests can start with preferred dates, party size, bedroom needs, pool/spa expectations, dock and kayak questions, beach-day versus quiet-river priorities, local recommendations, parking, children, mobility, pets, quiet-hours, and firepit questions. This sample form does not submit and availability is not live."
      },
      {
      ...
      },
      {
        ...
        title: "Make the local guide useful before it gets specific.",
        items: [
