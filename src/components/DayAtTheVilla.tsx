export default function DayAtTheVilla() {
  const day = [
    ...
    },
    {
      ...
      description: "Walk over to Taylor Bay in a minute or two for calm, shallow water, or launch one of the kayaks or paddleboards from the dock for a morning on the water.",
      emoji: "🛶",
