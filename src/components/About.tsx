export default function About() {
  return (
    <section id="about" className="py-28 md:py-40 bg-[#FAFAF8]">
      <div className="max-w-5xl mx-auto px-8 text-center">
        <p className="text-sm tracking-[0.3em] uppercase text-[#8B7355] mb-6">The Estate</p>
        <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-light text-[#2C2C2C] leading-tight text-balance mb-8">
          A Private Caribbean Estate
        </h2>
